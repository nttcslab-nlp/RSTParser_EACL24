    ...
    def update(
        ...
        for pred_tree, gold_tree in zip(pred_trees, gold_trees):
            ...
            self.match_span += len(
                [
                    bracket
                    for bracket in pred_brackets["span"]
                    if bracket in gold_brackets["span"]
                ]
            )
            self.match_nuc += len(
                [
                    bracket
                    for bracket in pred_brackets["nuc"]
                    if bracket in gold_brackets["nuc"]
                ]
            )
            self.match_rel += len(
                [
                    bracket
                    for bracket in pred_brackets["rel"]
                    if bracket in gold_brackets["rel"]
                ]
            )
            self.match_full += len(
                [
                    bracket
                    for bracket in pred_brackets["full"]
                    if bracket in gold_brackets["full"]
                ]
            )
